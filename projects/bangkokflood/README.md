...
### 🌧️ 1. เรดาร์ตรวจฝนสด กทม. & ระบบตรวจสอบสถานะ Real-Time (Live Weather Radar)
- **เรดาร์กลุ่มฝนสด (RainViewer Live Radar API):** เชื่อมต่อชั้นข้อมูลเรดาร์ตรวจสภาพกลุ่มเมฆฝนและพายุที่กำลังเคลื่อนผ่านกรุงเทพฯ แบบสด ๆ ฟรี 100% ไม่ต้องใช้ API Key อัปเดตทุก 10 นาที พร้อมปุ่มเปิด/ปิดบนแผนที่
...
- **ลิงก์ตรวจจราจรสดและน้ำท่วม 1-Click:** ปุ่มเปิด Google Maps Traffic Live (`&layer=t`), รายงานจุดน้ำท่วมถนน สำนักการระบายน้ำ กทม. (สนล.), และกล้อง CCTV จราจร
...
- **Multi Map Mode:** สามารถกดสลับมุมมองระหว่าง `[ 🌧️ เรดาร์ฝนสด ]`, `[ 🗺️ ถนน ]`, `[ 🛰️ ดาวเทียม ]`, และ `[ 📐 ผังภาพรวม ]` ได้ทันที
