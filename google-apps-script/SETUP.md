...
4. เปิด **Project Settings → Script Properties** และเพิ่ม:
   ...
   - `SPREADSHEET_ID` — ไม่จำเป็นสำหรับไฟล์นี้ เพราะตั้งค่า `1fDZ7-vJTw24meRWS1QrsA8cB4-rQveLOT2RPokZ37yM` ไว้ในโค้ดแล้ว ใช้ property นี้เฉพาะเมื่อต้องการเปลี่ยนไปยังชีตอื่น
