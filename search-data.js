const searchData = {
    th: [
        ...
        },
        {
            ...
            tags: ["จับเวลา", "เครื่องมือช่วยสอน", "timer", "classroom tool", "นาฬิกา"],
        ...
        },
        {
            ...
            tags: ["ฟิสิกส์ศึกษา", "simulation", "วิถีโค้ง", "projectile", "physics"],
        ...
        },
        {
            ...
            tags: ["ฟิสิกส์ศึกษา", "simulation", "ลูกตุ้ม", "pendulum", "physics"],
        ...
        },
        {
            ...
            tags: ["มินิเกมการเรียนรู้", "creative thinking", "innovation", "เกม", "ออกแบบ"],
        ...
        },
        {
            ...
            tags: ["การรู้เท่าทัน ai", "interactive map", "ai literacy", "แผนภาพ"],
            url: "./learning games/ai-literacy/index.html",
            type: "Interactive",
            icon: "🧠"
        },
        {
            title: "AI Literacy Game",
            ...
            tags: ["เกมการศึกษา", "ai literacy", "นักสืบ", "critical thinking"],
            url: "https://apisittongchai-github-io-ivtt.vercel.app/",
            type: "Game",
            icon: "🕵️‍♂️"
        },
        {
            ...
            tags: ["เครื่องมืออรรถประโยชน์", "utility", "qr code", "สร้าง", "generator"],
        ...
        },
        {
            ...
            tags: ["ประวัติ", "about", "cv", "resume", "ติดต่อ"],
            url: "about.html",
            type: "Page",
            icon: "👤"
        },
        {
            ...
            tags: ["วิจัย", "บทความ", "publication", "research", "paper"],
            url: "#publications",
            type: "Research",
            icon: "📚"
        },
    ...
    en: [
        {
            ...
            tags: ["teaching aid", "classroom tool", "quiz", "game", "kahoot"],
            url: "./learning games/kahoot-clone/index.html",
            type: "Tool",
            icon: "🏆"
        },
        {
            ...
            tags: ["timer", "teaching aid", "classroom tool", "stopwatch"],
            url: "./learning games/activity-timer/index.html",
            type: "Tool",
            icon: "⏱️"
        },
        {
            ...
            tags: ["physics education", "simulation", "projectile", "physics"],
            url: "./learning games/projectile-game/index.html",
            type: "Simulation",
            icon: "☄️"
        },
        {
            ...
            tags: ["physics education", "simulation", "pendulum", "physics"],
            url: "./learning games/pendulum/pendulum.html",
            type: "Simulation",
            icon: "⏳"
        },
        {
            ...
            tags: ["learning game", "creative thinking", "innovation", "brainstorming"],
            url: "./learning games/index.html",
            type: "Game",
            icon: "🎲"
        },
        {
            ...
            tags: ["ai literacy", "interactive map", "mindmap"],
            url: "./learning games/ai-literacy/index.html",
            type: "Interactive",
            icon: "🧠"
        },
        {
            ...
            tags: ["educational game", "ai literacy", "detective", "critical thinking"],
            url: "https://apisittongchai-github-io-ivtt.vercel.app/",
            type: "Game",
            icon: "🕵️‍♂️"
        },
        {
            ...
            tags: ["utility tool", "utility", "qr code", "generator"],
            url: "./applications/qrcodegenerator/index.html",
            type: "Utility",
            icon: "📱"
        },
        {
            ...
            tags: ["about", "profile", "cv", "resume", "contact"],
            url: "about-en.html",
            type: "Page",
            icon: "👤"
        },
        {
            ...
            tags: ["research", "publication", "paper", "stem"],
            url: "#publications",
            type: "Research",
            icon: "📚"
        },
